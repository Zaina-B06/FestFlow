        ...
        <div style={{ background: "#F7F8F0", minHeight: "100vh" }}>
            ...
            <div style={{ padding: "32px 36px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 32 }}>
                    {[
                        { label: "Shifts Completed", value: String(stats.shifts_completed), sub: "this month", accent: "#355872" },
                        { label: "Hours Volunteered", value: `${stats.hours_volunteered}h`, sub: "across events", accent: "#7AAACE" },
                        { label: "Tasks Done", value: String(stats.tasks_completed), sub: "completed", accent: "#355872" },
                        { label: "Impact Score", value: String(stats.impact_score), sub: "keep it up!", accent: "#7AAACE" },
                    ].map((card, i) => (
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 24 }}>
                    ...
                    <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E8EDE8", padding: "24px 28px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                            {events.length === 0 && (
                                <p style={{ fontSize: 13, color: "#7AAACE", textAlign: "center", padding: "20px 0" }}>
