...
import { volunteer, notifications, events } from "../data/mockData";
        ...
        <div style={{ background: "#F7F8F0", minHeight: "100vh" }}>
            ...
            <div style={{ padding: "32px 36px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 32 }}>
                    {[
                        { label: "Events Applied", value: "2", sub: "1 confirmed", accent: "#355872" },
                        { label: "Shifts Completed", value: "7", sub: "this month", accent: "#7AAACE" },
                        { label: "Hours Volunteered", value: "24h", sub: "across 3 events", accent: "#355872" },
                        { label: "Impact Score", value: "94", sub: "Top 10% volunteer", accent: "#7AAACE" },
                    ].map((card, i) => (
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 24 }}>
                    ...
                    <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E8EDE8", padding: "24px 28px" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 22 }}>
                            <div>
                                <h2 style={{ fontSize: 18, fontWeight: 800, color: "#355872", margin: "0 0 4px", letterSpacing: "-0.3px" }}>Upcoming Events</h2>
                                ...
                                <div key={event.id} style={{ display: "flex", gap: 16, padding: "16px", background: "#F7F8F0", borderRadius: 12, border: "1px solid #E8EDE8", alignItems: "center" }}>
                                    ...
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                                            ...
                                            {event.spotsLeft <= 5 && event.status !== "full" && <span style={{ background: "#FFF3CD", color: "#856404", fontSize: 10, fontWeight: 700, padding: "2px 8px", borderRadius: 20 }}>{event.spotsLeft} spots left</span>}
                                        </div>
                                    ...
                                    <button disabled={event.status === "full"} style={{
                                        ...
                                        fontSize: 12, fontWeight: 700, cursor: event.status === "full" ? "default" : "pointer", flexShrink: 0,
                                    }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        ...
                        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E8EDE8", padding: "20px 22px" }}>
                            ...
                            {notifications.slice(1, 5).map((n, i) => {
                                const dotColor = { alert: "#C0392B", weather: "#D97706", info: "#7AAACE", success: "#355872" }[n.type] || "#7AAACE";
                                return (
                                    <div key={i} style={{ display: "flex", gap: 12, padding: "10px 0", borderBottom: i < 3 ? "1px solid #F7F8F0" : "none" }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ fontSize: 11, color: "#7AAACE", margin: 0 }}>{n.time}</p>
                                        </div>
                                    </div>
                                );
                            })}
