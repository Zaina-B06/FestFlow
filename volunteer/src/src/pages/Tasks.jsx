...
export default function Tasks() {
  ...
  const MOCK_TASKS = [
    {
      id: "mock-1",
      title: "Crowd Management – Main Stage",
      location: "Main Stage Area, Gate A",
      status: "active",
      due_time: "3:00 PM",
      notes: "Ensure no overcrowding near the front barrier. Coordinate with security if density exceeds limit.",
      checklist: [
        { id: "c1", label: "Check barrier integrity", is_done: true },
        { id: "c2", label: "Count crowd density every 15 min", is_done: true },
        { id: "c3", label: "Confirm radio channel with security", is_done: false },
        { id: "c4", label: "Brief incoming shift volunteer", is_done: false },
      ],
    },
    {
      id: "mock-2",
      title: "Artist Green Room Setup",
      location: "Backstage Block B",
      status: "pending",
      due_time: "4:30 PM",
      notes: "Set up refreshments and seating for performing artists. Check rider requirements.",
      checklist: [],
    },
    {
      id: "mock-3",
      title: "Registration Desk Assistance",
      location: "Main Entrance – Tent 2",
      status: "pending",
      due_time: "5:00 PM",
      notes: "Help attendees collect wristbands and event kits.",
      checklist: [],
    },
    {
      id: "mock-4",
      title: "Sound Check Support",
      location: "Amphitheatre Stage",
      status: "upcoming",
      due_time: "6:15 PM",
      notes: "Assist the AV team with cable management and mic placement for the evening headliner.",
      checklist: [],
    },
  ];
