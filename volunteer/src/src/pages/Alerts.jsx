  ...
  const MOCK_NOTIFICATIONS = [
    {
      id: "mock-n1",
      type: "alert",
      title: "Crowd Surge at Gate B – Immediate Action",
      body: "Density sensors at Gate B have exceeded safe thresholds. Move to assist crowd control. Coordinate with security on channel 4.",
      created_at: new Date(Date.now() - 5 * 60 * 1000).toISOString(),
    },
    {
      id: "mock-n2",
      type: "weather",
      title: "Weather Advisory – Thunderstorm Possible",
      body: "Met Dept reports a 60% chance of lightning after 6 PM. Outdoor stage shifts may be suspended. Stay tuned for updates.",
      created_at: new Date(Date.now() - 22 * 60 * 1000).toISOString(),
    },
    {
      id: "mock-n3",
      type: "info",
      title: "Shift Reminder – Main Stage at 3:00 PM",
      body: "Your crowd management shift begins in 30 minutes. Please report to Gate A for a quick brief.",
