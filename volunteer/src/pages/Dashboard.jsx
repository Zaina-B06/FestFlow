                                ...
                                {coordinators.map((c, i) => (
                                    <div key={i} style={{ border: "1px solid #E8EDE8", borderRadius: 12, padding: "18px 20px", background: "#F7F8F0" }}>
                                        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                                            <div style={{ width: 42, height: 42, borderRadius: "50%", background: i === 0 ? "#355872" : "#7AAACE", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 800, color: i === 0 ? "#9CD5FF" : "#fff" }}>{c.avatar}</div>
                                            <div>
                        ...
                        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E8EDE8", padding: "24px 28px" }}>
                            ...
                            {faqs.map((faq, i) => (
                                <div key={i} style={{ borderBottom: i < faqs.length - 1 ? "1px solid #F7F8F0" : "none" }}>
                                    <button onClick={() => setOpenFaq(openFaq === i ? null : i)} style={{ width: "100%", padding: "16px 0", background: "none", border: "none", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer", textAlign: "left" }}>
                                        <span style={{ fontSize: 14, fontWeight: 600, color: "#355872" }}>{faq.q}</span>
                                        <span style={{ fontSize: 18, color: "#7AAACE", flexShrink: 0, marginLeft: 12, transform: openFaq === i ? "rotate(180deg)" : "none", transition: "transform 0.2s", display: "inline-block" }}>▾</span>
                                    </button>
                                    {openFaq === i && (
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E8EDE8", padding: "22px 24px" }}>
                            ...
                            {submitted ? (
                                <div style={{ textAlign: "center", padding: "20px 0" }}>
                                    ...
                                    <button onClick={() => { setSubmitted(false); setMessage(""); }} style={{ padding: "8px 20px", background: "#F7F8F0", border: "1px solid #D6E4EE", borderRadius: 10, fontSize: 12, fontWeight: 600, color: "#355872", cursor: "pointer" }}>
                                        Submit Another
                                    </button>
                                </div>
                            ) : (
                                <>
                                    ...
                                    <select value={subject} onChange={e => setSubject(e.target.value)} style={{ width: "100%", padding: "9px 12px", border: "1px solid #D6E4EE", borderRadius: 10, fontSize: 13, color: "#355872", background: "#F7F8F0", marginBottom: 16, outline: "none" }}>
                                    ...
                                    <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder="Describe your issue..." style={{ width: "100%", height: 110, padding: "10px 12px", border: "1px solid #D6E4EE", borderRadius: 10, fontSize: 13, resize: "none", background: "#F7F8F0", color: "#355872", marginBottom: 16, outline: "none" }} />
                                    <button onClick={() => message.trim() && setSubmitted(true)} style={{ width: "100%", padding: "12px", background: "#355872", border: "none", borderRadius: 10, color: "#9CD5FF", fontWeight: 800, fontSize: 13, cursor: "pointer" }}>
                                        Submit Ticket
                                    </button>
                                </>
                            )}
                        ...
                        <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #E8EDE8", padding: "18px 20px" }}>
                            ...
                            {[
                                ...
                                "If lost, radio channel CH-09 connects to all coordinators.",
                            ].map((tip, i) => (
